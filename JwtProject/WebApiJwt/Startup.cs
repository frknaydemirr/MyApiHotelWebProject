        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(opt =>
            {
                    ...
                    opt.TokenValidationParameters=new TokenValidationParameters()
                    {
                      ...
                      //jwt den gelen parametrede doðrulanacak deðer
                      ValidateIssuerSigningKey= true, //imza doðrulamasý
                      ValidateLifetime = true,//geçerlilik süresi kontrolü
                      ClockSkew=TimeSpan.Zero //zamansal olarak istediðim formatý yürütebiliyorum!
                    };
            });
